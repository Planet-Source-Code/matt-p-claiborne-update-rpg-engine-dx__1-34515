...
Input #1, T
MAP_HEIGHT = T
ReDim Map(MAP_WIDTH / 32, MAP_HEIGHT / 32, 1) As Integer
...
B1.Left = Map(Int((Xr + Xt) / 32), Int((Yr + Yt) / 32), 0)
B1.Right = B1.Left + 32
B1.Top = 0
B1.Bottom = 32
...
ddrval = suOff1.Blt(B2, Tiles, B1, DDBLTFAST_DONOTWAIT)
...
ddrval = suOff1.Blt(r1, CharSprite, r2, DDBLTFAST_DONOTWAIT Or DDBLT_KEYSRC)

ddrval = suPrim.Blt(rTemp, suOff1, Rdum, DDBLT_WAIT)
